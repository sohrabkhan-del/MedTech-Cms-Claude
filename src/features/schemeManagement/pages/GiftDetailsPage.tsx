        ...
        <Stack direction="row" spacing={1.5} sx={{ alignItems: 'center' }}>
          ...
          <Box>
            <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }}>
              ...
              <Chip size="small" label={gift.status === 'active' ? 'Active' : 'Inactive'} color={gift.status === 'active' ? 'success' : 'default'} />
            </Stack>
        ...
        <SectionCard title="Summary">
          <DetailFieldGrid
            fields={[
              ...
              { label: 'Current Status', value: <Chip size="small" label={gift.status === 'active' ? 'Active' : 'Inactive'} color={gift.status === 'active' ? 'success' : 'default'} /> },
            ]}
          />
        </SectionCard>
