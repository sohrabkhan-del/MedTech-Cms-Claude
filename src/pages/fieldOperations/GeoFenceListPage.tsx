...
import { mockGeoFences, geoFenceKpis } from '@/features/fieldOperations/mockGeoFences'
import type { GeoFence, GeoFenceUserType } from '@/types/geoFence'
...
export function GeoFenceListPage() {
  ...
  const filteredFences = mockGeoFences.filter((fence) => {
