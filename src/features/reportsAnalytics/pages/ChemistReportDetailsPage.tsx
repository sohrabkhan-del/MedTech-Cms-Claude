...
export function ChemistReportDetailsPage() {
  ...
  const redemptionEntries = chemist.PointsHistory.filter(
          ...
          <Grid container spacing={2.5} sx={{ mb: 2.5 }}>
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <InfoItem
                ...
                value={chemist.registeredAddress}
              />
            </Grid>
          </Grid>
          ...
          <DetailFieldGrid
            fields={[
              ...
              { label: 'Assigned MR', value: chemist.assignedMr },
              {
                ...
                value: chemist.geoTagStatus === 'tagged' ? 'Tagged' : 'Pending',
              },
            ]}
          />
        </SectionCard>
        ...
        <Grid container spacing={3}>
          ...
          <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
            <StatCard
              ...
              value={summary.currentWalletBalance.toLocaleString('en-IN')}
        ...
        <SectionCard title="Performance Summary">
          <DetailFieldGrid
            fields={[
              ...
              {
                label: 'Average Points / Scan',
                value: summary.averagePointsPerScan,
              },
              {
                label: 'Total Points Earned',
                value: summary.totalPointsEarned.toLocaleString('en-IN'),
              },
              {
                label: 'Total Points Redeemed',
                value: summary.totalPointsRedeemed.toLocaleString('en-IN'),
              },
              {
