...
export function SchemeReportDetailsPage() {
  ...
  const productColumns: CommonTableColumn<SchemeApplicableProduct>[] = [
    {
      key: 'productId',
      header: 'Product',
      minWidth: 220,
      render: (row) => getGiftById(row.productId)?.giftName ?? row.productId,
    },
          ...
          <Box>
            <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }}>
              ...
              <Chip
                size="small"
                label={
                  report.schemeType === 'general'
                    ? 'General Scheme'
                    : 'Seasonal Scheme'
                }
                color={report.schemeType === 'general' ? 'default' : 'info'}
              />
            </Stack>
        ...
        <SectionCard title="Scheme Summary">
          <DetailFieldGrid
            fields={[
              ...
              {
                label: 'Type',
                value: report.schemeType === 'general' ? 'General' : 'Seasonal',
              },
        ...
        <Grid container spacing={3}>
          <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
            <StatCard
              ...
              value={report.enrolledPartners.toLocaleString('en-IN')}
              icon={<Users size={20} />}
              iconColor="primary"
            />
          </Grid>
          <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
            <StatCard
              ...
              value={report.dealerTotal.toLocaleString('en-IN')}
          ...
          <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
            <StatCard
              ...
              value={report.chemistTotal.toLocaleString('en-IN')}
              icon={<GiftIcon size={20} />}
              iconColor="warning"
            />
          </Grid>
          <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
            <StatCard
              ...
              value={scheme.applicableProducts.length}
              icon={<GiftIcon size={20} />}
              iconColor="success"
            />
          </Grid>
              ...
              <Grid key={partnerType} size={{ xs: 12, sm: 6 }}>
                ...
                >
                  <Box>
                    ...
                    >
                      {partnerType === 'Dealer'
                        ? scheme.partners.dealer.length
                        : scheme.partners.chemist.length}{' '}
                      partners
                    </Typography>
                  </Box>
                </Stack>
