...
import { mockGeneralSchemes, generalSchemeKpis, schemeTypeOptions, schemeApplicableUserOptions } from '@/features/schemes/mockSchemes'
...
export function GeneralSchemesListPage() {
  ...
  const filteredSchemes = useMemo(
    () =>
      mockGeneralSchemes.filter((scheme) => {
