...
import type { AuditActionType, AuditEntityType, AuditLogEntry, AuditModule, AuditStatus, AuditUserRole } from '@/types/auditLog'
    ...
    <>
      <Grid container spacing={3} sx={{ mb: 3 }}>
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
          <StatCard label="Total Audit Entries" value={auditLogKpis.totalEntries} icon={<ClipboardListIcon size={20} />} iconColor="primary" />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
          <StatCard label="Login Activities" value={auditLogKpis.loginActivities} icon={<LogIn size={20} />} iconColor="info" />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
          <StatCard label="Record Updates" value={auditLogKpis.recordUpdates} icon={<PencilLine size={20} />} iconColor="secondary" />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
          <StatCard label="Export Activities" value={auditLogKpis.exportActivities} icon={<Download size={20} />} iconColor="warning" />
        </Grid>
      </Grid>
