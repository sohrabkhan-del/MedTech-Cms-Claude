...
} from '@/features/systemUsers/adminFormSchema'
import { getAdminById } from '@/features/systemUsers/mockAdmins'

const regions: AdminFormValues['regionAccess'][] = ['Pan India', 'North', 'South', 'East', 'West']
const roles: AdminFormValues['role'][] = ['Super Admin', 'Admin']
const statuses: AdminFormValues['status'][] = ['active', 'pending', 'inactive']
...
export function AdminFormPage() {
  ...
  const admin = isEdit ? getAdminById(adminId) : undefined
