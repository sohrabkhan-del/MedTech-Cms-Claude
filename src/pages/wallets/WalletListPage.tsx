...
import { mockWallets, walletKpis } from '@/features/wallets/mockWallets'
import type { PartnerZone } from '@/types/partner'
import type { Wallet, WalletStatus, WalletUserType } from '@/types/wallet'
    ...
    <>
      <Grid container spacing={3} sx={{ mb: 3 }}>
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
          <StatCard label="Total Wallet Balance" value={walletKpis.totalWalletBalance.toLocaleString('en-IN')} icon={<WalletIcon size={20} />} iconColor="primary" />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
          <StatCard label="Total Coins Earned" value={walletKpis.totalCoinsEarned.toLocaleString('en-IN')} icon={<Coins size={20} />} iconColor="success" />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
          <StatCard label="Total Coins Redeemed" value={walletKpis.totalCoinsRedeemed.toLocaleString('en-IN')} icon={<Repeat2 size={20} />} iconColor="secondary" />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
          <StatCard label="Pending Redemptions" value={walletKpis.pendingRedemptions.toLocaleString('en-IN')} icon={<Clock3 size={20} />} iconColor="warning" />
        </Grid>
      </Grid>
