...
export function NotificationsListPage() {
  ...
  const columns: CommonTableColumn<AppNotification>[] = [
    ...
    },
    {
      ...
      render: (row) => (
        <Chip
          label={priorityConfig[row.priority].label}
          size="small"
          color={priorityConfig[row.priority].color}
          variant="filled"
        />
      ),
    },
    ...
    },
    {
      ...
      render: (row) => (
        <Chip
          ...
          size="small"
          color={row.isRead ? undefined : 'secondary'}
  ...
  return (
    <>
      ...
      <CommonTable
        ...
        searchKeys={(row) =>
          `${row.title} ${row.message} ${categoryConfig[row.category].label}`
        }
