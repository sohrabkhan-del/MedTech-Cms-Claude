...
import { mockProductionBatches, productionBatchKpis } from '@/features/inventory/mockProductBatches'
import { productCategoryOptions } from '@/features/inventory/mockProducts'
import type { BatchActiveStatus, ProductionBatch } from '@/types/productBatch'
...
export function BatchListingTab({ onViewBatch }: BatchListingTabProps) {
  ...
  const filteredBatches = useMemo(
    () =>
      mockProductionBatches.filter((batch) => {
